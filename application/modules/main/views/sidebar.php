<!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: rgba(5, 19, 67, 1);">
    <!-- Brand Logo -->
    <a href="index3.html" class="brand-link" style="background-color: rgba(5, 19, 67, 1);">
    ...
    <div class="sidebar" style="margin-top: 125px;">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block" <?= @$row != null ? '':'data-toggle="modal" data-target="#login-modal"'?> ><?= @$row != null ? '@'.$row->username:'Login'?></a>
        </div>
      </div>
